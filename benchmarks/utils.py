...
def load_train_data(datadir):
  x_train = load(os.path.join(datadir, 'k49-train-imgs.npz'))
  y_train = load(os.path.join(datadir, 'k49-train-labels.npz'))
  return x_train, y_train

def load_test_data(datadir):
  x_test = load(os.path.join(datadir, 'k49-test-imgs.npz'))
  y_test = load(os.path.join(datadir, 'k49-test-labels.npz'))
